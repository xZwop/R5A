class Replica extends Isolate {
  ...
  void init(String textAreaID, String identifier, SendPort deliverPort) {
    this._identifier = identifier;
    this._clock = 1;
    this._idTable = new List<LineIdentifier>();
    this._textZone = document.query('#' + textAreaID);
    this._currentText = '';
  ...
  void deliver(LogootPatch patch, String identifier) {
